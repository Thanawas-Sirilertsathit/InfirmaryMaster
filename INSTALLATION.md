...
4. In case you need admin user to verify the staff users, create one user by registering as patient named Admin. After that running this command in the terminal.
